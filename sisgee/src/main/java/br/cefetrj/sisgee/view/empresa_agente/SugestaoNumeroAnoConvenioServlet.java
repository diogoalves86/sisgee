...
public class SugestaoNumeroAnoConvenioServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            request.setAttribute("numeroEmpresa", IncluirCadastroEmpresaServlet.gerarNumeroConvenio());
            request.setAttribute("numeroPessoa", IncluirCadastroEmpresaServlet.gerarNumeroConvenio());
